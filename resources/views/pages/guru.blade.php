        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="flex items-center space-x-3">
                        <div class="avatar placeholder">
                            ...
                            >
                            @if( $guru->foto)
                            <img style="background: url('{{ asset('storage/' . $guru->foto) }}'); background-size:cover"> 
                            @else
                            <span>{{substr($guru->user->name, 0, 1)}}</span>
                            @endif
                            </div>
                        </div>
                        <div>
                ...
                <th style="display: flex">
                    <a  href="{{ route('guru.edit', $guru->user_id) }}"
                        class="btn btn-ghost btn-xs"
                        >details</a>

                    <form action="{{ route('guru.destroy',$guru->user_id) }}" method="post">
